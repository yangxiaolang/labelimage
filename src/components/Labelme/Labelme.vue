  ...
  <div class="labelme">
    <div style="display:flex;border:gray 1px solid">
      ...
      >
        ...
        >
          <el-button slot="trigger" type="text"><i
      ...
      <el-tooltip
        ...
        placement="right"
      >
        <el-button type="text" @click="exportJSON"><i
          style="font-size:18px;"
      ...
      >
        ...
        ><i class="iconfont icon-drag"></i></el-button>
      </el-tooltip>
      <el-tooltip
        class="item"
        effect="dark"
      ...
      >
        ...
        ><i class="iconfont icon-juxing"></i></el-button>
      </el-tooltip>
      <el-tooltip
        class="item"
        effect="dark"
      ...
      >
        ...
        ><i class="iconfont icon-duobianxing"></i></el-button>
      </el-tooltip>
    ...
    <div class="list" @click="$refs['board'].clearSelect()">
      <div class="card">
        ...
        <div style="display:flex;justify-content:space-between;align-item:center">
          ...
          <el-button type="text" style="padding:0 10px" @click="$refs['board'].clearAll()">清空</el-button>
        </div>
        <el-divider></el-divider>
        <el-table
          :data="tableData"
        ...
        >
          ...
          >
            <template slot-scope="scope">
              ...
              <el-input v-else v-model="scope.row.name" @keyup.native.enter="scope.row.edit=false" @input="e=>handleGraphNameChange(scope.row,e)"></el-input>
            </template>
          </el-table-column>
          <el-table-column
            label="操作"
          ...
          >
            <template slot-scope="scope">
              <el-button
                type="text"
                @click="toggleGraphShow(scope.row)"
              >{{ scope.row.visible?'隐藏':'显示' }}</el-button>
              <el-button
                type="text"
                style="color:red;"
  ...
  methods: {
    ...
    exportJSON() {
      if (this.imageInfo.imageUrl !== '') {
        ...
        const { imageName, imageData, imageHeight, imageWidth } = this.imageInfo
